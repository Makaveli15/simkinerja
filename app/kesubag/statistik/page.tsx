...
export default function KesubagStatistikKinerjaPage() {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      let url = `/api/kesubag/statistik?jenis=${tampilkan}`;
        ...
        <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
          ...
          <div className="overflow-x-auto">
            ...
            {tampilkan === 'tim' && (
              <table className="w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-emerald-50 to-blue-50 border-b border-emerald-100">
