    ...
    try {
      ...
      const avgProgres = dataForExport.length > 0 
        ? (dataForExport.reduce((sum, k) => {
            const outputRealisasi = k.jenis_validasi === 'dokumen' ? (k.dokumen_disahkan || 0) : (k.output_tervalidasi || 0);
                    ...
                    {kegiatanList.map((k) => (
                      <tr key={k.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <div className="w-28">
                            {(() => {
                              // Untuk jenis_validasi 'dokumen': gunakan dokumen_disahkan / target_output
                              // Untuk jenis_validasi 'kuantitas': gunakan output_tervalidasi / target_output
                              const isDokumen = k.jenis_validasi === 'dokumen';
                              const outputRealisasi = isDokumen 
                                ? (k.dokumen_disahkan || 0) 
                              ...
                              return (
                                <>
                                  ...
                                  <div className="text-xs text-gray-400 mt-0.5">
                                    {isDokumen 
                                      ? `${k.dokumen_disahkan || 0}/${Math.round(k.target_output || 0)} Dokumen`
